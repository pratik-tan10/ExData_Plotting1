...
par(mfrow=c(2,2))
#Add first plot
with(data2days, plot(FullTimeDate, Global_active_power, type="l", xlab="", ylab="Global Active Power"))
#Add second plot
with(data2days, plot(FullTimeDate, Voltage, type = "l", xlab="datetime", ylab="Voltage"))
#Add third plot
with(data2days, plot(FullTimeDate, Sub_metering_1, type="l", xlab="", ylab="Energy sub metering"))
#Add lines to third plot
...
#Add fourth plot
with(data2days, plot(FullTimeDate, Global_reactive_power, type="l", xlab="datetime", ylab="Global_reactive_power"))
